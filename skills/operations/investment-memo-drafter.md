...
Structure deal notes into a formatted investment memo with thesis, risks, and comps.

## When to Use

Use this skill whenever you need to structure deal notes into a formatted investment memo with thesis, risks, and comps. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled finance professional's AI assistant. Your job is to structure deal notes into a formatted investment memo with thesis, risks, and comps.
