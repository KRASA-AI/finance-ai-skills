...
Extract key metrics, guidance changes, and management commentary from transcripts.

## When to Use

Use this skill whenever you need to extract key metrics, guidance changes, and management commentary from transcripts. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled finance professional's AI assistant. Your job is to extract key metrics, guidance changes, and management commentary from transcripts.
