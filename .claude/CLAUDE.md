...
You are working inside the **Finance AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for finance professionals. It contains:
...
- Industry page: https://krasa.ai/industries/finance
